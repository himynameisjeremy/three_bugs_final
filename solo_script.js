...
for (i = 0; i < object.length; i++) {
  CreateObject.employeesName = object[i][0];
  CreateObject.employeesSalary = object[i][1];
  CreateObject.employeesBonus = object[i][2];
  CreateObject.totalComp = object[i][3];
  console.log(CreateObject.employeesName, CreateObject.employeesSalary, CreateObject.employeesBonus, CreateObject.totalComp);
}


//for (i = 0; i < object.length; i++) {
//  CreateObject = (object[0], object[1], object[2], object[3]);
